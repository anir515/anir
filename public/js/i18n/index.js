export const translations = {
  "en": {
    ...
    "pdf-toast-saved": "PDF saved successfully to Download/BU",
    ...
    "menu-animation-desc": "Animated Background, Shapes & Brightness",
    "label-anim-enable": "Animated Background",
    "label-anim-shape": "Background Shapes",
    "label-anim-brightness": "Brightness",
    "anim-shape-particles": "Particles",
    "anim-shape-bubbles": "Bubbles",
    "anim-shape-waves": "Waves",
    "anim-shape-stars": "Stars",
    ...
    "howtouse-steps": ["Copy a link from any supported platform.","Return to BU and tap the Paste button.","Wait for the analysis to finish.","Tap Download to save."],
    "about-text": "BU is a fast and versatile media downloader. Built with love by coflyn.",
    "share-msg": "Check out BU, an awesome app to download media from anywhere! https://github.com/coflyn/Mori",
    ...
    "share-panel-title": "BU Quick Save",
  ...
  "id": {
    ...
    "pdf-toast-saved": "PDF berhasil disimpan di Download/BU",
    ...
    "label-shareapp": "Bagikan Aplikasi BU",
    "label-offline": "OFFLINE",
    "btn-share": "BAGI",
    ...
    "howtouse-steps": ["Salin tautan dari platform yang didukung.","Kembali ke BU dan tekan tombol Tempel.","Tunggu hingga analisis selesai.","Tekan Unduh untuk menyimpan."],
    "about-text": "BU adalah pengunduh media yang cepat dan serbaguna. Dibuat dengan cinta oleh coflyn.",
    "share-msg": "Cobain BU, aplikasi keren untuk mengunduh media dari mana saja! https://github.com/coflyn/Mori",
    ...
    "share-panel-title": "BU Simpan Cepat",
  ...
  "ja": {
    ...
    "desc-wipedata": "警告：これにより、履歴とBUフォルダ内のすべてのダウンロード済みファイルが完全に削除されます。ファイルを保持したい場合は、別のフォルダに移動してください。続行しますか？",
    ...
    "pdf-toast-saved": "PDFが ダウンロード/BU に正常に保存されました",
    ...
    "howtouse-steps": ["サポートされているプラットフォームからリンクをコピーします。","BUに戻り、貼り付けボタンをタップします。","分析が完了するまで待ちます。","ダウンロードをタップして保存します。"],
    "about-text": "BUは高速で多機能なメディアダウンローダーです。coflynによって愛を込めて作られました。",
    "share-msg": "どこからでもメディアをダウンロードできる素晴らしいアプリ、BUをチェックしてください！ https://github.com/coflyn/Mori",
  ...
  "ko": {
    ...
    "pdf-toast-saved": "PDF가 Download/BU 폴더에 성공적으로 저장되었습니다",
    ...
    "howtouse-steps": ["지원되는 플랫폼에서 링크를 복사합니다.","BU로 돌아가서 붙여넣기 버튼을 누릅니다.","분석이 완료될 때까지 기다립니다.","다운로드를 눌러 저장합니다."],
    "about-text": "BU는 빠르고 다재다능한 미디어 다운로더입니다. coflyn이 사랑으로 만들었습니다.",
    "share-msg": "어디서나 미디어를 다운로드할 수 있는 멋진 앱 BU를 확인해 보세요! https://github.com/coflyn/Mori",
  ...
  "zh": {
    ...
    "pdf-toast-saved": "PDF 已成功保存至 Download/BU",
    ...
    "howtouse-steps": ["从任何支持的平台复制链接。","返回 BU 并点击粘贴按钮。","等待分析完成。","点击下载以保存。"],
    "about-text": "BU 是一款快速且多功能的媒体下载器。由 coflyn 用心制作。",
    "share-msg": "快来看看 BU，这是一款超棒的媒体下载应用！https://github.com/coflyn/Mori",
  ...
  "ar": {
    "btn-analyze": "تحليل",
    "batch-modal-title": "قائمة التحميل الجماعي",
    "batch-download-all": "تحميل الكل",
    "toast-no-batch-urls": "لم يتم العثور على روابط صالحة في النص",
    "label-batch-photo-mode": "وضع الصور الجماعي",
    "batch-photo-all": "تحميل جميع الصور",
    "batch-photo-pdf": "دمج في ملف PDF واحد",
    "batch-photo-first": "تحميل الصورة الأولى فقط",
    "loader-analyzing": "جاري تحليل الرابط...",
    "label-platforms": "المنصات المدعومة",
    "nav-home": "الرئيسية",
    "nav-history": "السجل",
    "nav-settings": "الإعدادات",
    "history-desc": "تحميلاتك الأخيرة",
    "settings-desc": "تخصيص تجربتك",
    "label-language": "اللغة",
    "label-darkmode": "الوضع الداكن",
    "label-storagesize": "الحجم الكلي للوسائط",
    "label-clearcache": "مسح ذاكرة التخزين المؤقت",
    "desc-clearcache": "إزالة الصور المصغرة المؤقتة ومعاينات الصور لتوفير المساحة. وسائطك المحملة تبقى آمنة. هل تريد المتابعة؟",
    "label-cache-cleared": "تم مسح ذاكرة التخزين المؤقت بنجاح!",
    "label-wipedata": "مسح جميع البيانات",
    "desc-wipedata": "إعادة تعيين السجل والإعدادات وذاكرة التخزين المؤقت. لن يتم حذف الفيديوهات أو الموسيقى المحملة من معرض الصور. هل تريد المتابعة؟",
    "label-data-wiped": "تمت إعادة ضبط التطبيق بنجاح. معرض الصور آمن!",
    "label-version": "الإصدار",
    "label-platform": "المنصة",
    "label-opening-wa": "جاري فتح واتساب...",
    "label-reportbug": "الإبلاغ عن خطأ",
    "label-developer": "المطوّر",
    "label-support": "ادعمني",
    "btn-edit": "تعديل",
    "btn-clear-all": "مسح الكل",
    "btn-done": "تم",
    "msg-clear-all-confirm": "هل أنت متأكد أنك تريد حذف كل سجل التحميلات؟",
    "msg-delete-item-confirm": "إزالة هذا العنصر من السجل؟",
    "btn-clear": "مسح",
    ...
    "loader-phrases": [
      ...
      "جاري جمع المحتوى...",
      "جاري البحث عن البكسلات...",
      "جاري معالجة الطلب...",
      "على وشك الانتهاء..."
    ],
    "toast-download-complete": "اكتمل التحميل",
    "pdf-btn-gallery": "حفظ كملف PDF (المعرض)",
    "btn-download-all-title": "تحميل الكل",
    "label-items-count": "${count} عنصر",
    "downloading-progress": "جاري التحميل...",
    "download-all-complete": "تم إضافة ${count} عنصر إلى قائمة التحميل!",
    "pdf-btn-images": "حفظ الصور كملف PDF",
    "pdf-pages": "الصفحات",
    "pdf-images-detected": "الصور المكتشفة",
    "pdf-toast-starting": "جاري بدء تصدير PDF... (قد تستغرق المعارض الكبيرة بعض الوقت)",
    "pdf-toast-processing": "تمت معالجة ${count}/${total} صورة...",
    "pdf-toast-finalizing": "جاري إنهاء بنية ملف PDF... يرجى الانتظار.",
    "pdf-toast-saving": "جاري الحفظ على الجهاز... قد يستغرق ذلك بضع ثوانٍ.",
    "pdf-toast-saved": "تم حفظ ملف PDF بنجاح في Download/BU",
    "pdf-error-no-images": "لم تتم معالجة أي صور صالحة.",
    "toast-storage-error": "خطأ في التخزين: تأكد من وجود مساحة كافية.",
    ...
    "toast-cache-error": "خطأ أثناء مسح ذاكرة التخزين المؤقت.",
    "toast-copy-success": "تم النسخ إلى الحافظة",
    "toast-copy-failed": "فشل النسخ",
    "label-modal-error": "خطأ في فتح النافذة",
    "label-howtouse": "كيفية الاستخدام",
    "label-about": "عن التطبيق",
    "btn-view": "عرض",
    "toast-connection-lost": "انقطع الاتصال. يرجى التحقق من الإنترنت.",
    "label-incognito": "الوضع الخفي",
    "label-keep-awake": "إبقاء الشاشة مضاءة",
    ...
    "label-download-sound": "صوت الاكتمال",
    "label-auto-retry": "إعادة المحاولة تلقائيًا",
    "label-path-video": "مسار الفيديو",
    "label-path-music": "مسار الموسيقى",
    "label-path-presets": "الاقتراحات الجاهزة",
    "btn-reset-default": "إعادة الضبط الافتراضي",
    "label-subfolder-downloads": "مجلد فرعي في التنزيلات",
    "label-privacy-lock": "قفل الخصوصية",
    "label-lock-type": "نوع القفل",
    "lock-type-none": "بدون",
    "lock-type-biometric": "بصمة/وجه",
    "lock-type-pin": "رمز PIN",
    "pin-enter-title": "أدخل رمز PIN المكوّن من 4 أرقام",
    "guide-title": "دليل الاستخدام",
    "guide-step-1": "انسخ أي رابط وسائط من TikTok وInstagram وYouTube وTwitter/X وDouyin وأكثر من 14 منصة أخرى.",
    "guide-step-2": "اضغط \"لصق\" (أو زر التحميل الجماعي بجانبه) لتحليل الرابط واختيار الجودة المفضلة.",
    "guide-step-3": "اضغط \"تحميل\" لحفظ الملفات مباشرة على تخزين الجهاز مع تتبع مباشر للتقدم.",
    "guide-step-4": "الوصول إلى الوسائط المحفوظة في السجل للتشغيل دون اتصال أو تأمينها بقفل البصمة.",
    "label-dont-show": "عدم الظهور مرة أخرى",
    "btn-open-settings": "فتح الإعدادات",
    "label-shareapp": "مشاركة تطبيق موري",
    "label-offline": "غير متصل",
    "btn-share": "مشاركة",
    "label-autoplay": "تشغيل الوسائط تلقائيًا",
    "label-autoloop": "تكرار الوسائط تلقائيًا",
    "label-font": "خط التطبيق",
    "label-fatal-error": "خطأ فادح",
    "menu-general-title": "عام",
    "menu-general-desc": "اللغة والأتمتة وأمان التطبيق",
    "menu-storage-title": "التخزين والتحميل",
    "menu-storage-desc": "مسارات الحفظ واسم الملف ومسح ذاكرة التخزين المؤقت",
    "menu-network-title": "الشبكة والأداء",
    "menu-network-desc": "الخادم المفضل ووكيل المستخدم وتوفير البيانات",
    "menu-appearance-title": "المظهر",
    "menu-appearance-desc": "السمة ولون التمييز والاهتزاز",
    "menu-animation-title": "الأنيميشن",
    "menu-animation-desc": "خلفية متحركة، أشكال ودرجة السطوع",
    "label-anim-enable": "الخلفية المتحركة",
    "label-anim-shape": "أشكال الخلفية",
    "label-anim-brightness": "السطوع",
    "anim-shape-particles": "جسيمات",
    "anim-shape-bubbles": "فقاعات",
    "anim-shape-waves": "أمواج",
    "anim-shape-stars": "نجوم",
    "menu-advanced-title": "متقدم",
    "menu-advanced-desc": "الاحتفاظ بالسجل والنسخ الاحتياطي التلقائي والمشغل",
    "menu-about-title": "حول ومعلومات المطوّر",
    "menu-about-desc": "الاسم، معلومات التواصل، وروابط المطوّر",
    "label-prefer-server": "الخادم المفضل",
    "server-ask": "السؤال دائمًا",
    "server-1": "الخادم 1 (الأساسي)",
    "server-2": "الخادم 2 (احتياطي)",
    "label-user-agent": "وكيل المستخدم (User-Agent)",
    "ua-default": "افتراضي",
    "ua-chrome": "كروم للجوال",
    "ua-safari": "سفاري iOS",
    "ua-desktop": "كروم لسطح المكتب",
    "label-request-timeout": "حد المهلة",
    "timeout-15": "15 ثانية",
    "timeout-30": "30 ثانية",
    "timeout-60": "60 ثانية",
    "timeout-120": "120 ثانية",
    "label-force-ipv4": "فرض وضع IPv4",
    "label-header-spoofing": "حماية من خطأ 403",
    "label-cellular-warning": "تحذير بيانات الجوال",
    "label-bypass-ssl": "تجاوز أخطاء SSL",
    "label-test-latency": "فحص زمن استجابة الخادم",
    "label-autodownload": "تحميل الرابط تلقائيًا",
    "label-wifi-only": "التحميل عبر الواي فاي فقط",
    "label-filename-template": "اسم الملف",
    "filename-title": "العنوان فقط",
    "filename-title-platform": "العنوان + المنصة",
    "filename-title-date": "العنوان + التاريخ",
    "font-default": "Inter",
    "font-jakarta": "Plus Jakarta Sans",
    "font-serif": "سيريف كلاسيكي",
    "font-mono": "مونو حديث",
    "font-display": "عريض للعرض",
    "label-auto-folder": "مجلد فرعي لكل منصة",
    "label-auto-clear-input": "مسح الإدخال تلقائيًا",
    "label-haptic": "الاهتزاز واللمس",
    "label-auto-analyze": "تحليل تلقائي عند اللصق",
    "label-history-limit": "حد السجل",
    ...
    "lang-ja": "اليابانية",
    "btn-close": "إغلاق",
    "msg-cellular-warning": "أنت متصل حاليًا ببيانات الجوال. هل تريد التحميل رغم ذلك؟",
    "toast-incognito-on": "تم تفعيل الوضع الخفي",
    "toast-incognito-off": "تم إيقاف الوضع الخفي",
    "toast-autopaste-on": "تم تفعيل اللصق التلقائي",
    "toast-autopaste-off": "تم إيقاف اللصق التلقائي",
    "toast-datasaver-on": "تم تفعيل توفير البيانات",
    "toast-datasaver-off": "تم إيقاف توفير البيانات",
    "toast-autoclear-history-on": "تم تفعيل مسح السجل التلقائي",
    "toast-autoclear-history-off": "تم إيقاف مسح السجل التلقائي",
    "toast-wifi-on": "تم تفعيل التحميل عبر الواي فاي فقط",
    "toast-wifi-off": "تم إيقاف التحميل عبر الواي فاي فقط",
    "toast-wifi-needed": "يلزم الاتصال بشبكة واي فاي",
    "toast-autodownload-on": "تم تفعيل التحميل التلقائي",
    "toast-autodownload-off": "تم إيقاف التحميل التلقائي",
    "lang-ko": "الكورية",
    "lang-zh": "الصينية (المبسطة)",
    "lang-ar": "العربية",
    "toast-privacy-on": "تم تفعيل قفل الخصوصية",
    "toast-privacy-off": "تم إيقاف قفل الخصوصية",
    "howtouse-steps": ["انسخ رابطًا من أي منصة مدعومة.","ارجع إلى موري واضغط على زر اللصق.","انتظر حتى ينتهي التحليل.","اضغط على تحميل للحفظ."],
    "about-text": "موري هو تطبيق سريع ومتعدد الاستخدامات لتحميل الوسائط.",
    "share-msg": "جرّب موري، تطبيق رائع لتحميل الوسائط من أي مكان!",
    "label-update-available": "يوجد تحديث",
    "label-update": "تحديث",
    "label-up-to-date": "أنت تستخدم أحدث إصدار.",
    "label-check-failed": "فشل التحقق",
    "label-check-failed-msg": "تعذر الوصول إلى الخادم. تحقق من اتصالك.",
    "placeholder-paste-link": "الصق الرابط هنا...",
    "placeholder-batch-link": "الصق عدة روابط (رابط في كل سطر)...",
    "btn-analyze-batch": "تحليل الدفعة",
    "err-yt-playlist-source": "قوائم تشغيل يوتيوب تتطلب خادم 'ytmp3.gg'.",
    "toast-download-failed": "فشل التحميل",
    "label-choose-server": "اختر الخادم:",
    "share-panel-title": "حفظ سريع - موري",
    "share-panel-sub": "تخصيص وتحميل الوسائط",
    "label-server-options": "خيارات الخادم",
    "label-available-downloads": "التحميلات المتاحة",
    "btn-cancel": "إلغاء",
    "label-option": "خيار",
    "label-saving": "جارٍ الحفظ...",
    "label-server": "الخادم",
    "share-err-unsupported": "رابط منصة غير مدعوم.",
    "share-err-failed": "فشل تحليل الرابط.",

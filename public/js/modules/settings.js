...
export let customPath = localStorage.getItem("mori_download_path") || "BU";
    ...
    `<div class="path-picker-ui">
       <div class="path-input-wrapper">
         ...
         <div class="mori-input-with-icon">
           ...
           <input type="text" id="customPathInput" class="mori-input-noborder" value="${customPath}" placeholder="e.g. BU">
         </div>
       </div>
       <span class="path-label-sm">${lang["label-path-presets"]}</span>
       <div class="path-presets-container">
         <button class="path-preset-chip" data-path="BU">BU</button>
         <button class="path-preset-chip" data-path="BU/Videos">BU/Videos</button>
       </div>
...
export let customMusicPath =
  localStorage.getItem("mori_music_path") || "BU/Music";
  ...
  showConfirm(
    ...
    `<div class="path-picker-ui">
       <div class="path-input-wrapper">
         ...
         <div class="mori-input-with-icon">
           <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>
           <input type="text" id="customMusicPathInput" class="mori-input-noborder" value="${customMusicPath}" placeholder="e.g. BU/Music">
         </div>
       </div>
       <span class="path-label-sm">${lang["label-path-presets"]}</span>
       <div class="path-presets-container">
         <button class="path-preset-chip" data-path="BU/Music">BU/Music</button>
...
export function updateLanguageUI() {
  ...
  if (currentLangDisplay) {
    const langNames = { en: "English", id: "Indonesia", ja: "日本語", ko: "한국어", zh: "中文", ar: "العربية" };
...
export async function updateStorageInfo() {
  ...
  try {
    ...
    if (tauriInvoke) {
      ...
      const primary = await getFolderSize("Download/BU", "EXTERNAL_STORAGE");
      const legacy = await getFolderSize("Download/BU", "EXTERNAL");
